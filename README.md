...
```
cd existing_repo
git remote add origin https://gitlab.gp1.aws.lge.com/gp1mig/gp1-mig-pdp-dcr.git
git branch -M master
...
- [ ] [Set up project integrations](https://gitlab.gp1.aws.lge.com/gp1mig/gp1-mig-pdp-dcr/-/settings/integrations)
